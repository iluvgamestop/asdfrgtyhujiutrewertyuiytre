...
client.on('message', message => {
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on("message", message => {
    if (message.content === "zhelp--1") {
     const embed = new Discord.RichEmbed() 
         .setThumbnail(message.author.avatarURL)
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/kuMagUs :scroll:
         :hearts: الموقع الرسمي للبوت soon website here  :hearts: **`)
   ...
   client.on("message", message => {
    if (message.content === "-help-m") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/kuMagUs :scroll:
         :hearts: الموقع الرسمي للبوتsoon website here  :hearts: **`)
   message.author.sendEmbed(embed)
...
**============ **
  ** zmove @user |  لسحب الشخص الى روومك** :confused: 

  ** zbc | رسالة جماعية الى كل اعضاء السيرفر** :mega:

  ** zrole @user <rank> | لأعطاء رتبة لعضو معين**:large_orange_diamond: 

  ** zroleremove @user <rank> | لازالة الرتبة من شخص معين** :orange_book: 

  ** zrole all <rank> | لأعطاء رتبة للجميع**:shield: 

  ** zrole humans <rank> | لأعطاء رتبة للاشخاص فقط **:man: , :woman: 

  **zrole bots <rank> | لأعطاء رتبة لجميع البوتات**:robot: 

  ** zschannel | اضهار الشات المخفية**:blush: 

  ** zhchannel | اخفاء الشات**:arrow_heading_down: 

  ** zclr <numbr> | مسح الشات بعدد**:information_source: 

  ** zclear | مسح الشات ** :recycle: 

  ** zmute @user <reason> | اعطاء العضو ميوت لازم رتبة <Muted>**:mute:

  ** zunmute @user | لفك الميوت عن الشخص ** :loud_sound:

  ** zkick @user <reason> | طرد الشخص من السيرفر**  :outbox_tray:

  ** zban @user <reason> | حضر الشخص من السيرفر** :no_entry:

  ** zmutechannel | تقفيل الشات**:no_entry:

  ** zunmutechannel | فتح الشات**:on:   

  ** zdc | مسح كل الرومات**

  ** zdr | <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات**

  ** zct <name> | انشاء شات**:rolling_eyes:

  ** zcv <name> | انشاء رووم فويس**:crown:

  ** zdelet <name> | مسح الشات او الرووم فويس**

  ** zccolors <number> | ينشا لك الوان مع كم الوان تبي**
...
`)
  ...
  ** zrps | حجر ورقة مقص ** :video_game:

  ** zspeed | اسرع كتابن ** :video_game:

  ** zquas | اسئلة عامة ** :video_game:

  ** zنكت | نكت ** :video_game:

  ** zلعبة فكك | فكك ** :video_game:

  ** zلعبة عواصم | عواصم** :video_game:

  **zلعبة كت تويت | كت تويت ** :video_game:

  ** zroll | قرعة راندوم** :video_game:

  ** zلو خيروك بطريقة حلوة | لوخيروك

  ** zلعبة مريم | مريم** :video_game: 
  
  ** zفوائد نصائح | هلتعلم ** :video_game: 
  
  ** zيعطيك عقابات قاسية |عقاب** :video_game: 
   `)
   message.author.sendEmbed(embed)
  ...
  ** zplay | لتشغيل اغنية برابط او بأسم** 

  ** zskip | لتجآوز الأغنية الحآلية**

  ** zpause | إيقآف الأغنية مؤقتا**

  ** zresume | ل**موآصلة الإغنية بعد إيقآفهآ مؤقتا

  ** zvol | لتغيير درجة الصوت 100 - 0**

  ** zstop | لإخرآج البوت من الروم**

  ** znp | لمعرفة الأغنية المشغلة حآليا**

  ** zqueue | لمعرفة قآئمة التشغيل**
...
**============ **
  ...
  ** zallbots | لعرض جميع البوتات الي بالسيرفر** :robot: 

  ** zserver |يعرض لك معلومات عن السيرفر**:fire: 

  ** zbot | يعرض لك كل معلومات البوت**:computer: 
  
  ** zskin <name> | يعرض لك سكنك بماين كرافت**:blush:

  ** zcount | يعرض لك عدد الاشخاص بالسيرفر بدون بوتات** :information_source:

  ** zinvites | يعرض لك  عدد انفايتاتك بالسيرفر ** :microscope: 

  ** zinvite-codes | يعرض لك روابط الانفايتات حكك في السيرفر **:spy: 

  ** zcal | اله حاسبة**:slot_machine: 

  ** ztrans <language> <any thing> | يترجم لك الي تبيه من اي لغة**:writing_hand: 

  ** zshort | يختصر لك رابط كبير الى رابط صغير**:mortar_board: 

  ** ztag | يكتب لك الكلمة بشكل جميل وكبير**:sunglasses: 

  ** zgoogle | للبحث في قوقل عن طريق الدسكورد**:desktop: 

  ** zperms | يعرض لك برمشناتك بالسيرفر**:pushpin: 

  ** zza5 | يزخرف لك كلمة او جملة**:hearts: 

  ** zrooms | يعرض لك كل الرومات الي بالسيرفر مع عددها**:rocket: 

  ** zroles | يعرض لك كل الرانكات بالسيرفر بشكل جميل**

  ** zemojilist | يعرض لك كل الايموجيات الي بالسيرفر**:cry: :smile: :joy: 

  ** zsay | يكرر الكلام الي تكتبو**:sparkles: 

  ** zimage | صورة السيرفر**:bust_in_silhouette: 

  ** zmembers | يعرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص**:selfie: 

  ** zprofile | ليعرض البرفايل حقك** 

  ** zbans | عدد الاشخاص المبندة **:no_entry: 

  ** zavatar | صورتك او صورة الي تمنشنو**:bust_in_silhouette:

  ** zembed | يكرر الي تقولو بشكل حلو**:small_blue_diamond: 

  ** zemoji <any things> | لتحويل اي كلمه تقولها الي ايموجي**:small_orange_diamond: 

  ** zinv | لدعوة البوت الى سيرفرك**:black_circle: 

  ** zsupport | سيرفر الدعم**:wrench:  :envelope_with_arrow: 
  
  ** zcontact | ارسال اقتراح او لمراسلة صاحب البوت**
...
if (message.content.startsWith('zlegend')){
...
if (!points[message.author.id]) points[message.author.id] = {
  ...
  if(!message.guild) return;
    let id = message.author.id,prefix="z";
...
client.on('message', message => {
    if (message.content.startsWith("zbans")) {
...
client.on('message', message => {
    if (message.content.startsWith("zavatar")) {
if(!message.channel.guild) return;
...
message.channel.stopTyping()
   ...
   client.on('message', message => {
     if (message.content === "zsupport") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/kuMagUs**")
...
Server owner: __${guild.owner}__**`)
			      ...
			      client.on("message", (message) => {
    if (message.content.startsWith('zdelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`zenox Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
